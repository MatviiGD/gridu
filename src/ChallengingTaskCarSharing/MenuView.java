...
public class MenuView {
    ...
    private void mainMenu() {
        while (true) {
            ...
            if (0 == input) return;
            if (1 == input) managerMenu();
            if (2 == input) service.showCustomers();
            if (3 == input) service.addCustomer();
        }
    }
    ...
    private void managerMenu() {
        while (true) {
            ...
            var input = Integer.parseInt(sc.next());
            if (0 == input) return;
            if (1 == input) service.showCompanies();
            if (2 == input) service.addCompany();
        }
    }
    ...
    void customerMenu(Customer customer) {
        while (true) {
            ...
            var input = Integer.parseInt(sc.next());
            if (0 == input) return;
            if (1 == input) service.rentACar(customer);
            if (2 == input) service.returnRentedCar(customer);
            if (3 == input) service.showRentedCar(customer);
        }
    }
    ...
    void companyMenu(Company company) {
        ...
        while (true) {
            ...
            var input = Integer.parseInt(sc.next());
            if (0 == input) return;
            if (1 == input) service.showCompanyCars(company);
            if (2 == input) service.addCar(company);
        }
    }
}